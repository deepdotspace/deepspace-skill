...
This skill targets **`deepspace` and `create-deepspace` v0.2.5** (latest published on npm at 05/04/2026; verify with `npm view deepspace version` if drift is suspected).
